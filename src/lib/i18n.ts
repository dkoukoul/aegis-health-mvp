...
const translations = {
  ...
  el: {
    ...
    city: "Πόλη",
    postal_code: "Τ.Κ.",
    insurance_provider: "Ασφαλιστικός Φορέας",
    insurance_number: "Αρ. Μητρώου",
    notes: "Σημειώσεις",
    create_patient: "Δημιουργία",
    no_matches: "Δεν βρέθηκαν αποτελέσματα για",
    click_to_add: "Πατήστε **+ Νέος Ασθενής** για προσθήκη.",
    table_name: "Ονοματεπώνυμο",
    table_amka: "ΑΜΚΑ",
    table_phone: "Τηλέφωνο",
    table_insurance: "Ασφάλεια",
    table_actions: "Ενέργειες",
    view: "Προβολή",
    delete: "Διαγραφή",
    confirm_delete: "Είστε σίγουροι ότι θέλετε να διαγράψετε αυτόν τον ασθενή;",
